...
public class MancalaController {
    ...
    public Response play(@Context HttpServletRequest request, PlayInputDTO body) {
        ...
        // If the game is finished, remove the gameId attribute
//        if(mancala.isEndOfGame()) session.removeAttribute("gameId");
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public Response getGame(@Context HttpServletRequest request){
        // Create HTTP session.
        HttpSession session = request.getSession(true);
